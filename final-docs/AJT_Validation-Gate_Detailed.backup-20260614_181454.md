...
1. Sales Input
- `stg_bi_sales`, `trn_sales_actual`

2. Employee Input
- `stg_hcm_employee`, `mst_employee`

3. Hierarchy
- `mst_org_hierarchy`, `vw_mst_org_hierarchy_detail`

4. Mapping (MT)
- `mst_salesman_mapping` (และตาม policy อาจมี `mst_product_mapping`)
