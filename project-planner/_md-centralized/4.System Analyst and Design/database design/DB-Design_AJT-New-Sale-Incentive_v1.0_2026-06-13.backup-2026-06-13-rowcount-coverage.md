...
**Schema:** dbo  
**Status:** Design Complete (POC Phase)
...
ฐานข้อมูล **AJT_SIS** รองรับการคำนวณ Incentive พนักงานขาย AJT 4 ช่องทาง (MT / TT / S&I / Laos) ประกอบด้วยตาราง 3 กลุ่มหลัก:
...
| Transaction | 6 | เป้า, ยอดขายจริง, ผลคำนวณ |
...
| calc_type | NVARCHAR(50) | NO | CASCADE_4_LEVEL / SINGLE_SHEET |
...
| TT | Traditional Trade | SINGLE_SHEET |
...
| salesman_code | |
| position_level_code | STAFF / SECT_MGR / DEPT_MGR / AD |
| product_code | |
| target_amount | เป้า |
...
04_ajt_sis_sample_data_full.sql     → Sample data ทุกกลุ่ม (Apr-2026 MT/TT scenario)
```
