...
BEGIN
    CREATE TABLE dbo.trn_sales_target (
        ...
        pct_salesman        DECIMAL(9,4)    NULL,       -- pre-computed goal_multiplier from sheet "%Salesman" column; NULL = compute from DB data
...
BEGIN
    CREATE TABLE dbo.trn_incentive_detail (
        ...
        salesman_code       NVARCHAR(50)    NOT NULL,
        position_level_code NVARCHAR(50)    NOT NULL,           -- STAFF | SECT_MGR | DEPT_MGR | DIV_MGR | AD
        product_code        NVARCHAR(50)    NOT NULL,
        target_amount       DECIMAL(18,2)   NOT NULL,
        actual_amount       DECIMAL(18,2)   NOT NULL,
...
BEGIN
    CREATE TABLE dbo.out_for_hr_variable (
        ...
        incentive_div       DECIMAL(18,2)   NOT NULL CONSTRAINT DF_out_hr_var_div DEFAULT (0),
