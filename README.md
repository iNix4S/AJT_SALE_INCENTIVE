...
> **GitHub Push Policy**: ปัจจุบัน push ได้เฉพาะ `src/`, `test-scenarios/`, `README.md` — เอกสาร workspace อื่นๆ เก็บในเครื่องและ OneDrive เท่านั้น
