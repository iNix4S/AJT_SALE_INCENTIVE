...
> **GitHub Push Policy**: ปัจจุบัน push ได้เฉพาะ `src/`, `test-scenarios/`, `database/`, `memory-bank/`, `README.md` — เอกสาร workspace อื่นๆ เก็บในเครื่องและ OneDrive เท่านั้น
...
5. ไฟล์ภายใต้ `memory-bank/` (AI agent context — เพื่อให้ clone ใหม่ก็เห็นสถานะโปรเจกต์ทันที)
